...
export default function HomeTabs() {
  ...
  return (
    <Box sx={{ flexGrow: 1, bgcolor: 'background.paper', display: { xs: 'none', sm: 'flex' } }}>
      <Tabs
      ...
      <h2>Automate Deployments to the Cloud Within a Secure Environment</h2>
        <p>Working parallel to the development  of your software project, our Microsoft Azure and AWS certified specialists employ fully automated Continuous Integration/Continuous Delivery (CI/CD) processes to deploy and test your platform on the cloud. Our focus is on ensuring your lifecycle is never disrupted, mitigating bottlenecks when it's time to deploy.</p>

        <Button className="icon-right-btn" variant="contained" endIcon={<ArrowRight />} href="/capabilities/devops-tools">EXPLORE DEVOPS TOOLS & PROCESSES</Button>
